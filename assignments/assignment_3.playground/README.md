...
3) Why did you choose class for ShoppingCart?
...
4) Why did you choose struct for Product and Order?
...
5) Explain one example where reference semantics matter in your code:
